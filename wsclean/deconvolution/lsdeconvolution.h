...
class LSDeconvolution : public TypedDeconvolutionAlgorithm<deconvolution::SingleImageSet>
{
    ...
    virtual void ExecuteMajorIteration(ImageSet& dataImage, ImageSet& modelImage, const ao::uvector<const double*>& psfImages, size_t width, size_t height, bool& reachedMajorThreshold) override final
		{
