...
private:
	...
	public:
		...
		void AddData(size_t n, const std::complex<float>* data, const bool* flags, const float* weights, const double* uvw, double time)
		{
		...
		void AddDataAndModel(size_t n, const std::complex<float>* data, const std::complex<float>* modelData, const bool* flags, const float* weights, const double* uvw, double time)
		{
			double weightSum = 0.0;
			for(size_t i=0; i!=n; ++i)
			{
		...
		void Get(size_t n, std::complex<float>* data, bool* flags, float* weights, double* uvw, double& time)
		{
			for(size_t i=0; i!=n; ++i)
			{
